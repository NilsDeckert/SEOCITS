...
# SENSOR INFO
You will receive info about the position of objects in your vicinity.
Y coordinates increase to the front of your starting position.
X coordinates increase to the right of your starting position.
...
```
Walk around the green object. Your position is (0, 0). The following objects are in your vicinity:
 - rgba(0, 1, 0, 1) cube of width 1.0, height 2 and length 1.0.
  Corners at positions (1.5, 1.5), (1.5, 2.5), (2.5, 1.5), (2.5, 2.5)
- rgba(1, 0, 0, 1) cube of width 1.0, height 2 and length 1.0.
  Corners at positions (-2.5, 1.5), (-2.5, 2.5), (-1.5, 1.5), (-1.5, 2.5)
- rgba(0, 0, 1, 1) cube of width 1.0, height 2 and length 1.0.
  Corners at positions (-0.5, -2.5), (-0.5, -1.5), (0.5, -2.5), (0.5, -1.5)
